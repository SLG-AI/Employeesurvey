...
const PUBLIC_PATHS = ["/login", "/signup", "/reset-password", "/s/", "/thank-you", "/auth/", "/api/surveys/", "/api/stripe/webhook", "/api/teams/bot-webhook", "/teams", "/suspended", "/onboarding/s/", "/api/onboarding/public/"];
