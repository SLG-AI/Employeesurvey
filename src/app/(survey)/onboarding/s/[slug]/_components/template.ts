...
// The 64+ check-items have been extracted to src/lib/onboarding/content.ts; each
// card body now holds an <!--ITEMS:x-y--> token that buildGuideHtml() fills in.
export const GUIDE_SHELL = `<style>
